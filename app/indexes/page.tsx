    ...
    <Box
      ...
      <Box
        ...
        <Box
          ...
          <ProvenanceNotice>
            Chapter titles, summaries and keywords on this page were generated by a language model from the transcripts.
            They have not yet been reviewed by an archivist. The transcripts and recordings themselves are unaltered.
          </ProvenanceNotice>
          <Box
            sx={{
              display: 'flex',
